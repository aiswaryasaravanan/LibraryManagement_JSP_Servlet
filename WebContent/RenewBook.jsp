...
<body>
	...
	%>
		<form action="UpdateOnRenew" method="post">
		<table width="100%">
...
/* 				s=transaction.getBook().getBookId()+"     "+transaction.getBook().getBookName()+"     "+transaction.getBook().getAuthor()+"     "+transaction.getIssueDate()+"     "+transaction.getDueDate();
 */			%>
			<br>
			<tr>
